...
function New({ workspace  }) {
    ...
    (0,external_react_.useEffect)(()=>{
        if (workspace === null) {
            ...
            const workspaceDetails = Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../../public/list.json'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())((el)=>el.name === atob(workspace[0]));
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ jsx_runtime_.jsx("button", {
                                onClick: downloadZip,
                                className: "p-4 relative z-10 px-5 bg-cyan-700 border-t border-white/20 border-solid hover:bg-slate-900 transition m-2 rounded items-center text-white/70 flex cursor-pointer",
                                children: "Download"
                            })
                        ]
                    })
